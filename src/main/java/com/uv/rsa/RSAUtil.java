...
public class RSAUtil {
     ...
     * 每次使用同样的随机种子
     */
    private static final byte[] SEED = "jj3csGt2iZlv4XXSbnxwpWwa4lQx1w==".getBytes();
    /**
    ...
    private static final int RSA_LENGTH = 512;
     ...
     */
    public static void genKeyPair(SecureRandom secureRandom) throws NoSuchAlgorithmException {
        // KeyPairGenerator类用于生成公钥和私钥对，基于RSA算法生成对象
        KeyPairGenerator keyPairGen = KeyPairGenerator.getInstance("RSA");
        // 初始化密钥对生成器，密钥大小为96-1024位
        keyPairGen.initialize(RSA_LENGTH, secureRandom);
        // 生成一个密钥对，保存在keyPair中
